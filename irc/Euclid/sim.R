...
lapply(varratios,function (rat) {
                  ...
                  write(sprintf("%10s,%10s,%5f,%5f,%5f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f", 
                    modx, mody, ssx, ssy, rat, wu/M, we/M, wf1/M, wf2/M, wf3/M, cpu/M, 
                    cpe/M, cpf1/M, cpf3/M, cpf3/M), dfile, append = TRUE)
                  data <- rbind(data, c(ssy, ssx, modx, mody, rat, wu/M, we/M, wf1/M, 
